...
export const metadata: Metadata = {
  ...
  description:
    "A marketplace for artisans and crafters to showcase and sell unique handcrafted items.",
};
  ...
  return (
    <html lang="en">
      ...
      >
        ...
        {/* Footer */}
        <footer className="bg-amber-700 text-center py-4 text-sm text-white-700 border-t">
